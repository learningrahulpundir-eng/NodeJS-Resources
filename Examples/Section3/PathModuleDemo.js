...
//#region Example - 1: Getting the file name from the path
...
// #region Example - 2: Getting the directory name from the path
// const path = require('path');
// const filePath = '/home/user/documents/file.txt';
...
// #region Example - 3: Getting the file extension from the path
// const path = require('path');
...
// #region Example - 4: Joining multiple path segments
// const path = require('path');
...
// #region Example - 5: Resolving a sequence of paths into an absolute path
const path = require('path');
